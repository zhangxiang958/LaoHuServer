...
CREATE TABLE team (
	team_id   VARCHAR(50) PRIMARY KEY NOT NULL,    /* 团队id */
...
CREATE TABLE member (
	member_id VARCHAR(50) PRIMARY KEY NOT NULL,	 /* 成员 id */
...
CREATE TABLE commentReply (
	reply_id VARCHAR(50) PRIMARY KEY NOT NULL,
	toComment_id VARCHAR(50),
	fromWho VARCHAR(50),
	toWho	VARCHAR(50),
	reply_time DATE,
